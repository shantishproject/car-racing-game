...
gamedisplays.blit(backgroundpic,(0,rel_ybackgroundpic.
get_rect().width))
gamedisplays.blit(backgroundpic,(700,rel_ybackgroundpic.
get_rect().width))
if rel_y<800:
...
if x > obs_startx and x < obs_startx + obs_width or x+car_width
